...
=======
        e = clock();
        std::cout <<"setWidget:" <<  e - s << std::endl;
        bInit = true;
        //设置回调，用于对MyTextReportWidget输出文本内容
        pWndSingle->AllBoxWork();
>>>>>>> e597408f3cb2168e95ad9886b485034f994e0b7c
...
=======
    ...
    void InitCallBaCk(GetMeasureParameterCallBack measureParameterCallBack, GetExplainParameterCallBack explainParameterCallBack)
    {
    ...
    void CrateByStructuralData(QWidget *parent, StructuralData &data, bool bReset)
    {
